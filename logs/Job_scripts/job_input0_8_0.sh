...
#PBS -N job_input0_8_0
#PBS -l nodes=1:ppn=12
#PBS -M taolue.yang@temple.edu
#PBS -o /home/tus53997/Benchmark_DNACompression/logs/logs/job_input0_8_0_output.log
#PBS -e /home/tus53997/Benchmark_DNACompression/logs/logs/job_input0_8_0_error.log
...
if [ "SZ3" == "SZ3" ]; then
    ...
    OUTPUT_SIZE=$(stat -c %s "/home/tus53997/Benchmark_DNACompression/Scripts/../CompressedOutput/ERR103405_2_F.bin_-f_-1_63866600_-M_REL_0.2.sz")
...
echo "job_input0_8_0,SZ3-f -1 63866600 -M REL 0.2,$DURATION,$RATIO" >> "/home/tus53997/Benchmark_DNACompression/logs/compression_metrics0.csv"
