...
#!/bin/bash
START_TIME=$SECONDS
singularity exec --bind /home/tus53997:/mnt /home/tus53997/sz3_perf_amd.sif /home/tus53997/Benchmark_DNACompression/ExternalDependencies/fqzcomp/fqzcomp -Q 2 /home/tus53997/Benchmark_DNACompression/Scripts/../Fastq/ERR103405_2.fastq /home/tus53997/Benchmark_DNACompression/Scripts/../CompressedOutput/ERR103405_2.fastq_-Q_2.fqz
END_TIME=$SECONDS
...
if [ "Other" == "SZ3" ]; then
    ...
    OUTPUT_SIZE=$(stat -c %s "/home/tus53997/Benchmark_DNACompression/Scripts/../CompressedOutput/ERR103405_2.fastq_-Q_2.fqz")
...
echo "job_input0_2_0,fqzcomp-Q 2,$DURATION,$RATIO" >> "/home/tus53997/Benchmark_DNACompression/logs/compression_metrics0.csv"
