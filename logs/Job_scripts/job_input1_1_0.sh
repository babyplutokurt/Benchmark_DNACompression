...
#!/bin/bash
START_TIME=$SECONDS
singularity exec --bind /home/tus53997:/mnt /home/tus53997/sz3_perf_amd.sif /home/tus53997/Benchmark_DNACompression/ExternalDependencies/fqzcomp/fqzcomp -Q 10 /home/tus53997/Benchmark_DNACompression/Scripts/../Fastq/ERR103405_1.fastq /home/tus53997/Benchmark_DNACompression/Scripts/../CompressedOutput/ERR103405_1.fastq_-Q_10.fqz
END_TIME=$SECONDS
...
if [ "Other" == "SZ3" ]; then
    ...
    OUTPUT_SIZE=$(stat -c %s "/home/tus53997/Benchmark_DNACompression/Scripts/../CompressedOutput/ERR103405_1.fastq_-Q_10.fqz")
...
echo "job_input1_1_0,fqzcomp-Q 10,$DURATION,$RATIO" >> "/home/tus53997/Benchmark_DNACompression/logs/compression_metrics1.csv"
