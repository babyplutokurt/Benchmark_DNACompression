...
#PBS -N job_input1_7_0
#PBS -l nodes=1:ppn=12
#PBS -M taolue.yang@temple.edu
#PBS -o /home/tus53997/Benchmark_DNACompression/logs/logs/job_input1_7_0_output.log
#PBS -e /home/tus53997/Benchmark_DNACompression/logs/logs/job_input1_7_0_error.log
...
if [ "SZ3" == "SZ3" ]; then
    ...
    OUTPUT_SIZE=$(stat -c %s "/home/tus53997/Benchmark_DNACompression/Scripts/../CompressedOutput/ERR103405_1_F.bin_-f_-1_63866600_-M_REL_0.1.sz")
...
echo "job_input1_7_0,SZ3-f -1 63866600 -M REL 0.1,$DURATION,$RATIO" >> "/home/tus53997/Benchmark_DNACompression/logs/compression_metrics1.csv"
