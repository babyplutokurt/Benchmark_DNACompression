...
#PBS -N job_input0_9_0
#PBS -l nodes=1:ppn=12
#PBS -M taolue.yang@temple.edu
#PBS -o /home/tus53997/Benchmark_DNACompression/logs/logs/job_input0_9_0_output.log
#PBS -e /home/tus53997/Benchmark_DNACompression/logs/logs/job_input0_9_0_error.log
...
echo "job_input0_9_0,SZ3-f -1 63866600 -M ABS 0.1,$DURATION,$RATIO" >> "/home/tus53997/Benchmark_DNACompression/logs/compression_metrics0.csv"
