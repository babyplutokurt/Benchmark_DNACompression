...
#PBS -N job_input0_4_0
#PBS -l nodes=1:ppn=12
#PBS -M taolue.yang@temple.edu
#PBS -o /home/tus53997/Benchmark_DNACompression/logs/logs/job_input0_4_0_output.log
#PBS -e /home/tus53997/Benchmark_DNACompression/logs/logs/job_input0_4_0_error.log
...
echo "job_input0_4_0,spring-c -l -q qvz 0.8,$DURATION,$RATIO" >> "/home/tus53997/Benchmark_DNACompression/logs/compression_metrics0.csv"
